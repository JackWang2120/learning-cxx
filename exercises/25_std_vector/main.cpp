...
int main(int argc, char **argv) {
    ...
    }
    {
        ...
        }
        {
            ...
            ASSERT(vec[5] == 'z', "Fill in the correct value.");
            ASSERT(vec[6] == 'z', "Fill in the correct value.");
            ASSERT(vec[7] == 'z', "Fill in the correct value.");
            ASSERT(vec[8] == 'z', "Fill in the correct value.");
        }
    }
